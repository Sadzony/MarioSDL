...
void Texture2D::Render(SDL_Rect posRect, SDL_Rect srcRect, SDL_RendererFlip flip, double angle)
{
    SDL_RenderCopyEx(m_renderer, m_texture, &srcRect, &posRect, angle, nullptr, flip);
}
